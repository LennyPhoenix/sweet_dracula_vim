...
let g:dracula#palette.bglighter = ['#343746', 238]
let g:dracula#palette.bglight   = ['#282A36', 237]
let g:dracula#palette.bg        = ['#0C0E14', 236]
let g:dracula#palette.bgdark    = ['#08080A', 235]
let g:dracula#palette.bgdarker  = ['#030208', 234]
